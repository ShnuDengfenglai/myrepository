...
<tr>
 	...
 	<td><%=sm.getSerCharge() %></td>
   	...
   	<td><a href="preUpdateServiceMaintain.do?id=<%=sm.getId()%>" class="button blue small">修改</a></td> 
   	<td><a href="deleteServiceMaintain.do?id=<%=sm.getId()%>" class="button blue small">删除</a></td>
</tr>
<%} %>
</table><br>

<a href="addServiceMaintain.jsp" class="button orange middle">添加服务项</a>&nbsp;
