...
<!-- <h1>修改服务维护页面</h1> -->
<%
ServiceMaintain sm=(ServiceMaintain)request.getAttribute("sm");
%>
<form action="updateServiceMaintain.do" method="post"><br>
...
<input type="hidden" name="id"  value=<%=sm.getId() %> /><br>
