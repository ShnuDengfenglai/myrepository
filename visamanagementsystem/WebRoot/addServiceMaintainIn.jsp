...
<title>addServiceMaintianIn</title>
<link href="outer.css" rel="stylesheet" type="text/css">
</head>
<body style="background:#F0F8FF;">

<p class="p bordered" style="text-align:center"><font color="black" size=5px ><b>添加入境服务项页面</b></font></p>
 
<div style="margin-left:50px;">
<!-- <h1>添加内容维护信息</h1> -->

<form action="addServiceMaintainIn.do" method="post"><br>
